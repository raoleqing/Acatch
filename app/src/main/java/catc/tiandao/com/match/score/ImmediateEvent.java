...
public class ImmediateEvent extends Fragment {
    ...
    private RecyclerView ie_recycler;
    ...
    public static ImmediateEvent newInstance(String param1, String param2) {
        ImmediateEvent fragment = new ImmediateEvent();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate( R.layout.fragment_immediate_event, container, false );
        viewInfo(view);
        return view;
    }
