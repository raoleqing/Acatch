...
public class EventFragment extends Fragment {
    ...
    public static EventFragment newInstance(int param1, String param2) {
    ...
    private void viewInfo(View view) {
        ...
        mAdapter.setListener( new BaseExpandableRecyclerViewAdapter.ExpandableRecyclerViewOnClickListener<MatchBen, Match>() {
             ...
             */
            @Override
            public boolean onGroupLongClicked(MatchBen groupItem) {
                return false;
            }
             ...
             */
            @Override
            public boolean onInterceptGroupExpandEvent(MatchBen groupItem, boolean isExpand) {
                return true;
            }
            ...
            @Override
            public void onGroupClicked(MatchBen groupItem) {
             ...
             */
            @Override
            public void onChildClicked(MatchBen groupItem, Match childItem) {
