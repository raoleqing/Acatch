...
public abstract class AutoLoopSwitchBaseView extends RelativeLayout implements ViewPager.OnPageChangeListener {
  ...
  private AutoSwitchViewPageInterface myInterface;
  ...
  public void setMyInterface(AutoSwitchViewPageInterface myInterface){
  ...
  public void onPageSelected(int i) {
    ...
    if(myInterface != null){
      myInterface.onPageSelected( i - 1 );
    }
  ...
  public void setPageShowViewVisibility(int visibility){

    mPageShowView.setVisibility( visibility );
  }


  public interface AutoSwitchViewPageInterface {
