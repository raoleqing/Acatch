 ...
 * Use the {@link SelectFragment1#newInstance} factory method to
...
public class SelectFragment1 extends Fragment implements View.OnClickListener{
    ...
    public static SelectFragment1 newInstance(int areaId, int ballType, int onType) {
        SelectFragment1 fragment = new SelectFragment1();
    ...
    class GetAllFootballEventRun implements Runnable{
        ...
        public void run() {
            ...
            HttpUtil.post( getActivity(),HttpUtil.GET_ALL_BASKETBALL_EVENT,param,new HttpUtil.HttpUtilInterface(){
                @Override
                public void onResponse(String result) {
