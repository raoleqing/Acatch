...
public class ImmediateAdapter extends RecyclerView.Adapter<ImmediateAdapter.MyViewHolder>  {
    ...
    public void onBindViewHolder(final MyViewHolder holder, int position) {
        ...
        if(mList.size() > 0){
            ...
            holder.title_text1.setText( "第"+(list.size() -position) +"节 " +  mJiShiBasket.getTime() );
        ...
        for(int i = 0; i< mList.size(); i++){
            ...
            LinearLayout top_layout = ViewUtls.find( view,R.id.top_layout );
            TextView title_text1 = ViewUtls.find( view,R.id.title_text1 );
            TextView title_text2 = ViewUtls.find( view,R.id.title_text2 );

            if(i == 0){
                top_layout.setVisibility( View.GONE );
            }

            title_text1.setText( "第"+(list.size() -position) +"节 " +  mJiShiBasket.getTime() );
            title_text2.setText( mJiShiBasket.getBiFen());
